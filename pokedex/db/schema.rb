...
ActiveRecord::Schema.define(version: 20_211_105_212_159) do
  ...
  create_table 'abilities_pokemons', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[pokemon_id ability_id], name: 'index_abilities_pokemons_on_pokemon_id_and_ability_id'
  end
  ...
  create_table 'games_pokemons', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[pokemon_id game_id], name: 'index_games_pokemons_on_pokemon_id_and_game_id'
  end
  ...
  create_table 'maestros_pokemons', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[pokemon_id maestro_id], name: 'index_maestros_pokemons_on_pokemon_id_and_maestro_id'
  end
  ...
  create_table 'moves_pokemons', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[pokemon_id move_id], name: 'index_moves_pokemons_on_pokemon_id_and_move_id'
  end
  ...
  create_table 'pokemons_stats', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[pokemon_id stat_id], name: 'index_pokemons_stats_on_pokemon_id_and_stat_id'
  end
  ...
  create_table 'pokemons_types', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[pokemon_id type_id], name: 'index_pokemons_types_on_pokemon_id_and_type_id'
  end
